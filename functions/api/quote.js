...
export async function onRequestPost(context) {
  ...
  if (delivery.missingConfig) {
    return quoteResponse({
      ...
      message:
        "This form is ready, but quote forwarding needs email, push, or webhook delivery configured in Cloudflare Pages. Please call or text (801) 604-2189 for live scheduling.",
    });
  }
