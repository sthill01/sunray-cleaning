...
PAGES = [
    ...
    },
    {
        ...
        "title": "Summit County House Cleaning, Vacation Rental Cleaning and Deep Cleaning | Sun Ray Cleaning",
        "description": "Summit County house cleaning, Airbnb and VRBO cleaning, deep cleaning, recurring cleaning, and move cleaning for Park City, Snyderville, Kamas, Oakley, and Coalville.",
        "h1": "Summit County cleaning from Park City to Kamas, Oakley, and Coalville.",
        "lead": "Sun Ray Cleaning serves Summit County homeowners, hosts, second-home owners, and rural households with residential cleaning, rental turnovers, deep cleaning, recurring cleaning, and move cleaning.",
        ...
        "plan": [
            ...
            "Deep cleaning and seasonal resets for ski homes, mountain homes, and high-use spaces.",
